...
public class Baraja {
    ...
    public void ejecutarAccionCarta(String tipoCarta, int indice, boolean barajar, Jugador jugador, Jugador banca,
            Tablero tablero, ArrayList<Jugador> jugadores, int tirada) {
